...
const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <div className="text-2xl font-display font-bold tracking-tighter uppercase cursor-pointer italic">
          BLAZE <span className="text-sanctum-orange not-italic">COMBAT</span>
        </div>
